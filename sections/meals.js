...
var SUPPER_RECIPES = [
  ...
  {id:'sp-spag-bol', cat:'pastapizza', goesWith:['Green salad','Garlic bread','Grated parmesan','A glass of red'], diet:'meat', protein:'beef', name:'Spaghetti Bolognese', emoji:'🍝', cuisine:'Italian', time:30, costPP:34,
  ...
  {id:'sp-beef-stew', cat:'stewscurries', goesWith:['Rice','Pap','Mashed potato','Crusty bread'], diet:'meat', protein:'beef', name:'Farmhouse Beef Stew', emoji:'🥘', cuisine:'South African', time:130, costPP:46,
  ...
  // ── 🍗 ROASTS ──
  {id:'sp-roast-chicken', cat:'ovenbakes', goesWith:['Roast potatoes','Steamed green veg','Gravy','Stuffing'], diet:'meat', protein:'chicken', name:'Lemon & Herb Roast Chicken & Veg', emoji:'🍗', cuisine:'Global', time:95, costPP:40,
...
var SIDES_BASICS_RECIPES = [
  {id:'sb-chips', cat:'potato', diet:'veg', protein:'veg', name:'Chips', emoji:'🍟', cuisine:'South African', time:35, costPP:8,
