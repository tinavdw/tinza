...
var SUPPER_RECIPES = [
  ...
  {id:'sp-capemalay-curry', cat:'stewscurries', goesWith:['Yellow rice','Sambal','Blatjang (apricot chutney)','Roti','Sliced banana'], diet:'meat', protein:'chicken', name:'Cape Malay Chicken Curry', emoji:'🍛', cuisine:'Cape Malay', time:55, costPP:32,
    ...
    versions:[
      {name:'Sunday Pot',icon:'🏆',default:true,time:75,costPP:38,nutrition:{kcal:600,protein_g:34,carbs_g:60,fat_g:24},
        ...
        method:['Fry the sliced onion slowly in the oil until soft and deep golden, 10 minutes — do not rush this.','Add the garlic-ginger paste, curry powder, a cinnamon stick and bay leaves; fry 1 minute until fragrant.','Stir in the tomatoes and apricot jam and cook to a thick base, 6 minutes.','Add the chicken, turn to coat, then pour in water to come halfway up. Cover and simmer very gently 40 minutes.','Add the potatoes and cook 25 minutes more until soft and the chicken falls off the bone.','Stir a spoon of yoghurt through off the heat for body, season, and serve with yellow rice and sambals.']},
      ...
      {name:'Quick',icon:'\u26a1',time:35,costPP:28,nutrition:{kcal:560,protein_g:32,carbs_g:58,fat_g:20},
        ...
        method:['Fry the chopped onion in oil until soft.','Add the garlic-ginger and curry powder and fry 1 minute.','Add the tomato and cubed potato with a splash of water; simmer 12 minutes until the potato is nearly soft.','Add the cubed chicken breast and cook 8 minutes more until just done — do not overcook or it goes dry.','Season and serve over rice.']},
  ...
  {id:'sp-cottage-pie', cat:'ovenbakes', goesWith:['Frozen peas','Green salad','Gravy'], diet:'meat', protein:'beef', name:'Cottage Pie', emoji:'🥧', cuisine:'British', time:65, costPP:38,
    ...
    method:['Brown the beef mince with the chopped onion and carrot until well coloured.','Add the stock and peas and simmer until thickened, then spoon into an oven dish.','Boil the potatoes until soft, then mash with the butter and a splash of milk until smooth.','Spread the mash over the mince, rough up the surface with a fork, top with grated cheddar and bake at 190°C for 25–30 minutes until golden.'],
    tip:'Rough up the mash with a fork before baking for extra-crispy golden peaks.',
    ...
    versions:[
      {name:'Classic',icon:'🏆',default:true,time:70,costPP:40,nutrition:{kcal:580,protein_g:27,carbs_g:52,fat_g:30},
        feel:'Rich beef gravy with carrots and peas under a generous cheese-topped mash, baked until golden and bubbling at the edges.',
        tip:'A spoon of tomato paste and a splash of Worcestershire in the mince deepen the gravy into proper savoury comfort.',
        didYouKnow:'The dish began as a thrifty way to use up Sunday\'s leftover roast — the mash lid sealed and stretched whatever cooked meat was left into a second meal.',
        ingredients:[{n:'beef mince',pp:140,u:'g'},{n:'potatoes',pp:320,u:'g'},{n:'onion',pp:60,u:'g'},{n:'carrots',pp:70,u:'g'},{n:'frozen peas',pp:50,u:'g'},{n:'beef stock',pp:120,u:'ml'},{n:'butter',pp:20,u:'g'},{n:'cheddar',pp:30,u:'g'},{n:'milk',pp:30,u:'ml'}],
        method:['Brown the mince with the onion and carrot.','Add the stock (plus tomato paste if you have it) and peas; simmer to a thick gravy.','Boil and mash the potatoes with butter and milk.','Spread over the mince, fork the top, scatter cheddar and bake 190°C for 30 minutes until golden.']},
      {name:'Budget',icon:'💰',time:65,costPP:28,nutrition:{kcal:520,protein_g:20,carbs_g:60,fat_g:20},
        feel:'Lentils stretch the mince and extra mash fills the dish — a big, cheap, satisfying bake.',
        tip:'Replace a third of the mince with cooked brown lentils — they soak up the gravy and no one will notice.',
        didYouKnow:'Stirring cooked lentils into the mince stretches it a long way and adds fibre — a classic budget move that keeps the pie just as hearty.',
        ingredients:[{n:'beef mince',pp:80,u:'g'},{n:'brown lentils',pp:50,u:'g'},{n:'potatoes',pp:350,u:'g'},{n:'onion',pp:50,u:'g'},{n:'carrots',pp:70,u:'g'},{n:'frozen peas',pp:50,u:'g'},{n:'beef stock',pp:120,u:'ml'},{n:'butter',pp:15,u:'g'}],
        method:['Brown the mince with onion and carrot; stir in the cooked lentils.','Add stock and peas; simmer to a thick gravy.','Top with plenty of buttery mash, fork the surface and bake until golden.']},
      {name:'Quick',icon:'⚡',time:35,costPP:38,nutrition:{kcal:560,protein_g:26,carbs_g:52,fat_g:28},
        feel:'Instant or quick-boiled mash over a fast mince — comfort in half the time.',
        tip:'Use small diced or pre-boiled potato (or even good instant mash) and grill the top instead of a long bake.',
        didYouKnow:'Brown the mince and grill the assembled pie for a few minutes instead of baking from cold — the filling is already hot, so you only need to colour the top.',
        ingredients:[{n:'beef mince',pp:120,u:'g'},{n:'potatoes',pp:300,u:'g'},{n:'onion',pp:50,u:'g'},{n:'frozen peas',pp:50,u:'g'},{n:'beef stock',pp:100,u:'ml'},{n:'butter',pp:15,u:'g'},{n:'cheddar',pp:20,u:'g'}],
        method:['Boil diced potato until quick to mash.','Brown the mince and onion, add stock and peas, simmer 10 minutes.','Top with mash and cheese and grill 5–8 minutes until golden. Serve.']}
    ]},
  {id:'sp-chicken-pie', cat:'ovenbakes', goesWith:['Mash','Frozen peas','Green salad'], diet:'meat', protein:'chicken', name:'Chicken & Mushroom Pie', emoji:'🥧', cuisine:'British', time:60, costPP:30,
    ...
    method:['Cook the diced chicken, onion and sliced mushrooms in the butter until just done.','Stir in the flour, then the milk, and simmer into a creamy sauce. Season and cool slightly.','Spoon into a pie dish and lay the rolled-out puff pastry over the top, sealing the edges.','Brush with a little milk and bake at 200°C for 25–30 minutes until puffed and golden.'],
    ...
    versions:[
      {name:'Puff-Topped',icon:'🏆',default:true,time:60,costPP:32,nutrition:{kcal:540,protein_g:31,carbs_g:34,fat_g:30},
        feel:'Creamy chicken and mushrooms under a high, golden, shatteringly crisp puff lid, glazed to a shine.',
        tip:'Brush the pastry with beaten egg rather than milk for a deeper golden, glossy shine.',
        didYouKnow:'Puff pastry gets its hundreds of crisp layers from "lamination" — folding butter into the dough again and again, so it puffs into leaves as the water in the butter turns to steam.',
        ingredients:[{n:'chicken fillets',pp:150,u:'g'},{n:'puff pastry',pp:90,u:'g'},{n:'mushrooms',pp:70,u:'g'},{n:'onion',pp:45,u:'g'},{n:'milk',pp:90,u:'ml'},{n:'cake flour',pp:14,u:'g'},{n:'butter',pp:14,u:'g'},{n:'eggs',pp:1,u:'each'}],
        method:['Cook the chicken, onion and mushrooms in butter until just done.','Stir in flour, then milk; simmer to a thick, creamy sauce. Cool slightly.','Spoon into a dish, lay over the puff pastry and seal; cut a slit.','Glaze with beaten egg and bake 200°C for 28 minutes until high and golden.']},
      {name:'Budget',icon:'💰',time:60,costPP:24,nutrition:{kcal:500,protein_g:24,carbs_g:40,fat_g:26},
        feel:'More mushrooms and onion, a little less chicken — the creamy pie made to stretch.',
        tip:'Mushrooms are cheaper than chicken and add savoury depth — load them up and ease back on the meat.',
        didYouKnow:'Mushrooms bring a savoury, almost meaty depth, so loading up on them lets you use less chicken without the pie tasting any less rich.',
        ingredients:[{n:'chicken fillets',pp:90,u:'g'},{n:'puff pastry',pp:80,u:'g'},{n:'mushrooms',pp:120,u:'g'},{n:'onion',pp:50,u:'g'},{n:'milk',pp:90,u:'ml'},{n:'cake flour',pp:12,u:'g'},{n:'butter',pp:12,u:'g'}],
        method:['Cook the chicken, plenty of mushrooms and onion in butter.','Stir in flour and milk; simmer to a creamy sauce.','Top with pastry, slit and bake until golden.']},
      {name:'Family Double-Crust',icon:'👨‍👩‍👧',time:70,costPP:34,nutrition:{kcal:600,protein_g:30,carbs_g:46,fat_g:34},
        feel:'Pastry top AND bottom for a proper hand-held family pie — crisp all the way round.',
        ...
        ingredients:[{n:'chicken fillets',pp:140,u:'g'},{n:'puff pastry',pp:140,u:'g'},{n:'mushrooms',pp:70,u:'g'},{n:'onion',pp:45,u:'g'},{n:'milk',pp:90,u:'ml'},{n:'cake flour',pp:14,u:'g'},{n:'butter',pp:14,u:'g'},{n:'eggs',pp:1,u:'each'}],
        method:['Line a dish with pastry and blind-bake 10 minutes at 200°C.','Make the creamy chicken-and-mushroom filling; cool slightly.','Fill the base, lay over a pastry lid and seal; cut a slit and glaze with egg.','Bake 200°C for 30 minutes until golden top and bottom.']}
    ]},
  ...
  {id:'sp-roast-beef', cat:'ovenbakes', goesWith:['Gravy','Roast potatoes','Green salad'], diet:'meat', protein:'beef', name:'Roast Beef', emoji:'🥩', cuisine:'British', time:110, costPP:38,
    ...
    versions:[
      {name:'Sunday Roast',icon:'🏆',default:true,time:120,costPP:42,nutrition:{kcal:600,protein_g:42,carbs_g:34,fat_g:30},
        ...
        method:['Bring the beef to room temperature; pat dry, oil and season hard.','Sear all over, then roast at 200°C, 15 min per 500g for medium.','Roast the potatoes in beef fat alongside until crisp.','Rest the beef 15–20 minutes; make gravy with flour, pan juices and stock.','Carve thin across the grain and serve.']},
      {name:'Budget Pot-Roast',icon:'💰',time:180,costPP:30,nutrition:{kcal:520,protein_g:38,carbs_g:34,fat_g:24},
        ...
        method:['Brown the cheaper joint all over in a heavy pot.','Add the onion, stock and veg to come halfway up the meat.','Cover and braise at 150°C for 3 hours, turning once, until fork-tender.','Rest, then slice or pull; thicken the cooking liquid into gravy.']},
      {name:'Herb-Crusted',icon:'🌟',time:120,costPP:55,nutrition:{kcal:620,protein_g:44,carbs_g:30,fat_g:34},
        ...
        method:['Bring the joint to room temperature; season and sear all over.','Brush with mustard, then press on a mix of breadcrumbs and chopped herbs.','Roast at 200°C, 15 min per 500g, with potatoes alongside.','Rest 15–20 minutes; make gravy and carve thin.']}
    ]},
  ...
  {id:'sp-lamb-bredie', cat:'stewscurries', goesWith:['Rice','Pap','Crusty bread','Sweet potato'], diet:'meat', protein:'lamb', name:'Lamb Tomato Bredie', emoji:'\ud83c\udf72', cuisine:'South African', time:120, costPP:47,
    ...
    versions:[
      ...
      {name:'Green Bean',icon:'\ud83c\udf3f',time:130,costPP:46,nutrition:{kcal:500,protein_g:34,carbs_g:26,fat_g:28},
        ...
        method:['Brown the lamb in batches and set aside.','Soften the onion, then add tomato, garlic and a pinch of sugar; cook to a base.','Return the lamb with the stock; simmer gently 1 hour.','Add the sliced green beans and cubed potato and cook a further 45 minutes until everything is meltingly soft. Season and serve.']}
    ]},
  {id:'sp-butter-chicken', cat:'stewscurries', goesWith:['Basmati rice','Naan','Cucumber raita','Fresh coriander'], diet:'meat', protein:'chicken', name:'Butter Chicken', emoji:'\ud83d\udc14', cuisine:'Indian', time:45, costPP:36,
    ...
    versions:[
      ...
      {name:'Paneer',icon:'\ud83e\uddc0',time:35,costPP:34,nutrition:{kcal:520,protein_g:22,carbs_g:22,fat_g:38},
        ...
        method:['Fry the paneer cubes in a little of the butter until golden on the edges; set aside.','Soften the onion in the rest of the butter, add garlic-ginger and garam masala, fry 1 minute.','Add the tomato and a splash of water; simmer 10 minutes and blend smooth.','Stir in the cream, then fold in the paneer and warm through gently 3 minutes — do not boil hard or the paneer toughens. Serve with rice or naan.']}
    ]},
  {id:'sp-chicken-tikka-masala', cat:'stewscurries', goesWith:['Basmati rice','Naan','Fresh coriander','Lemon wedge'], diet:'meat', protein:'chicken', name:'Chicken Tikka Masala', emoji:'\ud83c\udf5b', cuisine:'Indian', time:45, costPP:32,
    ...
    versions:[
      ...
      {name:'Budget',icon:'\ud83d\udcb0',time:35,costPP:25,nutrition:{kcal:470,protein_g:32,carbs_g:22,fat_g:24},
        ...
        method:['Toss the diced thigh in yoghurt and garlic-ginger; char hard in the hot oil and set aside.','Soften the onion, add the garam masala, fry 1 minute.','Add the tomato and a splash of water; simmer 10 minutes.','Stir in the milk and the chicken, warm through, and finish with coriander. Season and serve.']},
  ...
  {id:'sp-chicken-tinga', cat:'stewscurries', goesWith:['Tortillas','Rice','Sour cream','Avocado','Fresh coriander'], diet:'meat', protein:'chicken', name:'Mexican Chicken Tinga', emoji:'🌮', cuisine:'Mexican', time:35, costPP:25,
    ...
    method:['Simmer the chicken thighs in the stock with half the onion for 15 minutes until cooked, then lift out and shred with two forks. Keep the cooking liquid.','Blend the tomato, the rest of the onion, the garlic and the smoked paprika into a smooth, smoky sauce.','Fry the sauce in the oil for 5 minutes until thickened and darkened.','Fold in the shredded chicken with a splash of the reserved stock and cook until rich and coating.','Serve in warm tortillas or over rice with coriander and a dollop of sour cream.'],
    ...
    versions:[
      ...
      {name:'Budget',icon:'💰',time:35,costPP:21,nutrition:{kcal:400,protein_g:32,carbs_g:16,fat_g:22},
        ...
        method:['Poach the thighs in the stock with half the onion; shred and keep the liquid.','Blend tomato, onion, garlic and paprika; fry in the oil until thick.','Fold in the chicken with plenty of the reserved stock to stretch it.','Serve in tortillas or over rice.']},
      {name:'Quick',icon:'⚡',time:20,costPP:27,nutrition:{kcal:420,protein_g:34,carbs_g:14,fat_g:24},
        ...
        method:['Blend the tomato, onion, garlic and smoked paprika to a sauce.','Fry it in the oil 5 minutes until thick.','Fold in the shredded cooked chicken and a splash of stock; warm through.','Pile into tortillas with your toppings.']}
    ]},
  {id:'sp-chorizo-hake-orzo', cat:'stewscurries', goesWith:['Green salad','Garlic bread','Lemon','Fresh parsley'], diet:'meat', protein:'fish', name:'Spanish Chorizo & Hake Orzo', emoji:'🐟', cuisine:'Spanish', time:40, costPP:55,
    ...
    versions:[
      {name:'Smoky One-Pan',icon:'🏆',default:true,time:40,costPP:55,nutrition:{kcal:560,protein_g:36,carbs_g:58,fat_g:22},
        ...
        method:['Fry the sliced chorizo until its oil runs orange and smoky.','Soften the onion with the smoked paprika.','Stir in the orzo, then the tomato and stock; simmer 10 minutes until almost tender.','Nestle the hake on top, cover, cook 6–8 minutes until it flakes.','Finish with parsley and lemon.']},
      {name:'Budget',icon:'💰',time:35,costPP:38,nutrition:{kcal:520,protein_g:30,carbs_g:60,fat_g:18},
        ...
        method:['Render the little bit of chorizo, then soften the onion with extra paprika to make up the smoke.','Stir in the orzo, tomato and stock; simmer until almost tender.','Lay the hake on top and steam until it flakes. Season and serve.']},
      {name:'Quick',icon:'⚡',time:25,costPP:55,nutrition:{kcal:560,protein_g:36,carbs_g:58,fat_g:22},
        ...
        method:['Render the chorizo, soften the onion with paprika.','Add orzo, tomato and stock; simmer 9 minutes.','Stir chunks of hake through for the last 5 minutes until just cooked. Serve.']},
      {name:'Salmon & Prawn',icon:'🌟',time:45,costPP:85,nutrition:{kcal:620,protein_g:40,carbs_g:56,fat_g:30},
        ...
        method:['Render the chorizo, soften the onion with the paprika.','Stir in the orzo, tomato and stock; simmer 10 minutes until almost tender.','Nestle the salmon on top, cover and cook 4 minutes; add the prawns and cook 3 minutes more until pink and the salmon flakes.','Stir in the cream off the heat, finish with parsley and lemon, and serve.']}
    ]},
  {id:'sp-chicken-cacciatore', cat:'stewscurries', goesWith:['Crusty bread','Mash','Rice','Green salad'], diet:'meat', protein:'chicken', name:'Chicken Cacciatore', emoji:'🍗', cuisine:'Italian', time:50, costPP:32,
    ...
    versions:[
      ...
      {name:'White (in bianco)',icon:'🍷',time:55,costPP:35,nutrition:{kcal:490,protein_g:35,carbs_g:10,fat_g:32},
        ...
        method:['Brown the thighs hard, skin-side first; set aside.','Soften the onion and garlic, then pour in the wine and reduce by half.','Add the stock and olives, return the chicken, cover and braise 35 minutes.','Finish with a squeeze of lemon and serve.']}
    ]},
  {id:'sp-lamb-guinness-stew', cat:'stewscurries', goesWith:['Mash','Crusty bread','Peas'], diet:'meat', protein:'lamb', name:'Lamb & Guinness Stew', emoji:'🍺', cuisine:'Irish', time:130, costPP:50,
    ...
    versions:[
      {name:'Low & Slow',icon:'🏆',default:true,time:150,costPP:54,nutrition:{kcal:580,protein_g:36,carbs_g:36,fat_g:30},
        ...
        method:['Toss the lamb in seasoned flour; brown hard in batches.','Soften the onion, scraping the pan.','Return the lamb with stout, stock, carrots and potato.','Cover and braise the lowest heat 2–2.5 hours until spoon-tender.','Season and rest before serving with mash.']},
      {name:'Budget',icon:'💰',time:140,costPP:36,nutrition:{kcal:540,protein_g:32,carbs_g:40,fat_g:26},
        ...
        method:['Flour and brown the neck/shoulder pieces.','Soften the onion, return the lamb with stout, stock and plenty of carrot and potato.','Braise low 2 hours until tender. Season and serve.']},
      {name:'Beef & Guinness',icon:'🐄',time:150,costPP:42,nutrition:{kcal:560,protein_g:36,carbs_g:38,fat_g:26},
        ...
        method:['Flour and brown the beef hard in batches.','Soften the onion, return the beef with stout, stock, carrots and potato.','Cover and braise low 2.5 hours until silky. Season and serve with mash.']}
    ]},
  {id:'sp-trini-pelau', cat:'stewscurries', goesWith:['Coleslaw','Green salad','Fresh thyme'], diet:'meat', protein:'chicken', name:'Trinidadian Pelau', emoji:'🍚', cuisine:'Caribbean', time:50, costPP:27,
    ...
    versions:[
      {name:'Burnt Sugar',icon:'🏆',default:true,time:55,costPP:30,nutrition:{kcal:600,protein_g:30,carbs_g:66,fat_g:24},
        ...
        method:['Caramelise the sugar in the hot oil until very dark.','Sear the chicken in the caramel until coated.','Add onion, garlic, peas, rice, coconut milk, thyme and water.','Cover and simmer low 25 minutes until the rice is tender.','Rest, fluff and serve.']},
      {name:'Budget',icon:'💰',time:50,costPP:20,nutrition:{kcal:560,protein_g:24,carbs_g:70,fat_g:18},
        ...
        method:['Darken the sugar in the oil, sear the chicken.','Add plenty of rice and peas, the onion, coconut milk, thyme and water.','Cover and simmer 25 minutes. Rest and serve.']},
      {name:'Quick',icon:'⚡',time:35,costPP:27,nutrition:{kcal:580,protein_g:28,carbs_g:66,fat_g:22},
        ...
        method:['Caramelise the sugar, sear the diced chicken.','Add the onion, tinned peas, rice, coconut milk and water.','Cover and simmer 20 minutes until the rice is done. Fluff and serve.']}
    ]},
  {id:'sp-seafood-risotto', cat:'stewscurries', goesWith:['Green salad','Lemon','Garlic bread','White wine'], diet:'meat', protein:'fish', name:'Seafood Risotto', emoji:'🦐', cuisine:'Italian', time:40, costPP:60,
    ...
    versions:[
      ...
      {name:'Prawn & Pea',icon:'🦐',time:35,costPP:55,nutrition:{kcal:520,protein_g:28,carbs_g:66,fat_g:14},
        ...
        method:['Keep the stock warm. Soften onion and garlic, toast the rice.','Add wine, then stock a ladle at a time, stirring, 18 minutes.','Fold in the prawns for the last 4 minutes and the peas for the last 2.','Beat in the butter off the heat and serve.']},
      {name:'Mushroom (veg)',icon:'🍄',time:40,costPP:38,nutrition:{kcal:480,protein_g:14,carbs_g:68,fat_g:16},
        ...
        method:['Brown the sliced mushrooms hard in the oil until deep golden; set aside.','Soften the onion and garlic in butter; toast the rice.','Add wine, then warm stock a ladle at a time, stirring, 18 minutes.','Fold the mushrooms back in, then beat in the butter and parmesan off the heat. Serve at once.']},
      {name:'Smoked Salmon & Pea',icon:'🌟',time:35,costPP:72,nutrition:{kcal:560,protein_g:30,carbs_g:64,fat_g:20},
        ...
        method:['Keep stock warm. Soften the onion, toast the rice, add the wine.','Add stock a ladle at a time, stirring, 18 minutes; add the peas for the last 2.','Off the heat, beat in the butter, then fold through torn smoked salmon and a squeeze of lemon.','Serve immediately while silky.']}
    ]},
  {id:'sp-bombay-egg-potato', cat:'stewscurries', goesWith:['Rice','Roti','Fresh coriander','Banana sambal'], diet:'veg', protein:'veg', name:'Bombay Egg & Potato Curry', emoji:'🥔', cuisine:'Indian', time:35, costPP:20,
    ...
    versions:[
      ...
      {name:'Budget',icon:'💰',time:35,costPP:16,nutrition:{kcal:360,protein_g:15,carbs_g:46,fat_g:14},
        ...
        method:['Boil the eggs and plenty of cubed potato until done.','Fry the onion with the curry powder, turmeric and garlic-ginger.','Add the tomato and water; simmer to a sauce.','Fold in the potato and halved eggs, warm through, season and serve.']},
      {name:'Quick',icon:'⚡',time:30,costPP:20,nutrition:{kcal:380,protein_g:16,carbs_g:42,fat_g:16},
        ...
        method:['Boil the eggs and cubed potato together until done; drain.','Meanwhile fry the onion, curry powder and garlic-ginger, then add tomato and water and simmer to a sauce.','Fold in the potato and halved eggs, warm through and serve with rice or roti.']}
    ]},
  {id:'sp-coconut-chickpea-curry', cat:'stewscurries', goesWith:['Rice','Roti','Banana sambal','Fresh coriander','Lime'], diet:'vegan', protein:'veg', name:'Coconut Chickpea Curry', emoji:'🥥', cuisine:'Indian-inspired', time:30, costPP:33,
    ...
    versions:[
      ...
      {name:'Budget',icon:'💰',time:50,costPP:22,nutrition:{kcal:410,protein_g:16,carbs_g:48,fat_g:18},
        ...
        method:['Soak the dried chickpeas overnight, then boil in fresh water until tender (about 45 min) — do this ahead.','Fry the onion, then the garlic-ginger and curry powder, 1 minute.','Add the tomato and cook to a base.','Add the coconut milk and cooked chickpeas; simmer 10 minutes.','Wilt in the spinach, season and serve.']},
      {name:'Quick',icon:'⚡',time:15,costPP:33,nutrition:{kcal:400,protein_g:14,carbs_g:44,fat_g:20},
        ...
        method:['Fry the garlic-ginger and curry powder in the oil for a minute.','Add the tomato, coconut milk and drained chickpeas all at once; simmer 8 minutes.','Stir in the spinach to wilt, season and serve over rice.']},
      {name:'Sweet Potato',icon:'🍠',time:45,costPP:31,nutrition:{kcal:460,protein_g:14,carbs_g:58,fat_g:18},
        ...
        method:['Toss cubed sweet potato in a little oil and roast at 200°C for 25 minutes until caramelised at the edges.','Meanwhile fry the onion, then the garlic-ginger and curry powder.','Add the tomato and cook to a base, then the coconut milk and chickpeas; simmer 10 minutes.','Fold through the roasted sweet potato and the spinach; warm through and serve.']}
    ]},
  {id:'sp-dhal', cat:'stewscurries', goesWith:['Rice','Roti','Banana sambal','Fresh coriander'], diet:'vegan', protein:'veg', name:'Lentil & Spinach Dhal', emoji:'🌱', cuisine:'Indian', time:35, costPP:24,
    ...
    method:['Rinse the red lentils under cold water until it runs clear, then put them in a pot with the turmeric and three times their volume of water.','Bring to a boil, then turn down and simmer 20 minutes, stirring now and then, until the lentils collapse into a soft porridge. Top up with water if it gets too thick.','While that cooks, make the tarka: heat the oil in a small pan, add the cumin seeds and let them sizzle, then add the chopped onion and garlic-ginger and fry until golden.','Stir the tarka and the chopped tomato into the lentils and simmer 5 minutes more.','Add the spinach to wilt, season well with salt, and serve with rice or roti.'],
    ...
    versions:[
      ...
      {name:'Budget',icon:'💰',time:35,costPP:16,nutrition:{kcal:330,protein_g:18,carbs_g:52,fat_g:6},
        ...
        method:['Simmer the rinsed lentils with turmeric and water until soft, 20 minutes.','Fry the onion, cumin and garlic-ginger in the oil until golden.','Stir into the lentils with the tomato; simmer 5 minutes.','Season generously and serve with rice — it is a full meal on its own.']},
      {name:'Quick',icon:'⚡',time:25,costPP:24,nutrition:{kcal:340,protein_g:18,carbs_g:50,fat_g:8},
        ...
        method:['Fry the onion and garlic-ginger in the oil for 3 minutes.','Add the rinsed lentils, turmeric, tomato and plenty of water; simmer hard 15 minutes, stirring, until soft.','Wilt in the spinach, season and serve.']},
      {name:'Coconut Dhal',icon:'🥥',time:40,costPP:30,nutrition:{kcal:420,protein_g:18,carbs_g:50,fat_g:18},
        ...
        method:['Simmer the rinsed lentils with turmeric and water until soft.','Fry the onion, cumin and garlic-ginger and stir in with the tomato.','Pour in the coconut milk and simmer gently 5 minutes — do not boil hard.','Wilt in the spinach, season and serve.']}
    ]},
  {id:'sp-chilli-con-carne', cat:'stewscurries', goesWith:['Rice','Sour cream','Grated cheddar','Tortillas','Fresh coriander'], diet:'meat', protein:'beef', name:'Beef Chilli con Carne', emoji:'🌶️', cuisine:'Tex-Mex', time:45, costPP:32,
    ...
    versions:[
      {name:'Smoky Slow',icon:'🏆',default:true,time:90,costPP:36,nutrition:{kcal:500,protein_g:30,carbs_g:38,fat_g:26},
        ...
        method:['Soften the onion and garlic in the oil.','Brown the mince hard, in batches if needed, for deep colour.','Cook out the smoked paprika and cumin for a minute.','Add the tomato, beans and stock; simmer the lowest heat 60–75 minutes, stirring now and then.','Melt in the dark chocolate, season and rest 10 minutes before serving.']},
      {name:'Budget',icon:'💰',time:45,costPP:24,nutrition:{kcal:430,protein_g:24,carbs_g:46,fat_g:16},
        ...
        method:['Fry the onion, then brown the mince well.','Stir in the smoked paprika and cumin.','Add the tomato, a generous double helping of beans and the stock; simmer 30 minutes.','Season and serve over rice — the beans make it filling and cheap.']},
      {name:'Quick',icon:'⚡',time:30,costPP:32,nutrition:{kcal:460,protein_g:28,carbs_g:38,fat_g:22},
        ...
        method:['Brown the onion and mince together.','Add the smoked paprika and cumin, then the tomato and beans.','Simmer hard 20 minutes until thick. Season and serve.']},
      {name:'Three-Bean (veg)',icon:'🌱',time:35,costPP:26,nutrition:{kcal:400,protein_g:18,carbs_g:56,fat_g:10},
        ...
        method:['Soften the onion in the oil, then cook out the smoked paprika and cumin.','Add the tomato and all three drained beans with a splash of water.','Simmer 25 minutes, mashing a few beans to thicken.','Melt in the dark chocolate, season and serve.']}
    ]},
  {id:'sp-thai-green-curry', cat:'stewscurries', goesWith:['Jasmine rice','Fresh basil','Lime','Fresh coriander'], diet:'meat', protein:'chicken', name:'Thai Green Chicken Curry', emoji:'🥥', cuisine:'Thai', time:30, costPP:40,
    ...
    method:['Fry the green curry paste in a little oil over medium heat for 1–2 minutes until it smells fragrant — this blooms the spices.','Pour in about a third of the coconut milk and let it bubble and split slightly, then add the rest and bring to a gentle simmer.','Add the sliced chicken and the vegetables and simmer 8–10 minutes until the chicken is cooked through.','Season with the fish sauce and a pinch of sugar — taste and balance until it is savoury, a little sweet and fragrant.','Tear in the fresh basil off the heat and serve with jasmine rice.'],
    ...
    versions:[
      {name:'From-Scratch Paste',icon:'🏆',default:true,time:45,costPP:46,nutrition:{kcal:500,protein_g:33,carbs_g:18,fat_g:34},
        ...
        method:['Blitz or pound the green chilli, lemongrass, garlic-ginger and coriander into a rough paste.','Fry the paste in the oil 2–3 minutes until deeply fragrant.','Add a third of the coconut milk to sizzle, then the rest; bring to a simmer.','Add the chicken and vegetables; simmer 10 minutes.','Season with fish sauce and a pinch of sugar, tear in basil and serve with jasmine rice.']},
      {name:'Budget',icon:'💰',time:30,costPP:30,nutrition:{kcal:450,protein_g:28,carbs_g:20,fat_g:30},
        ...
        method:['Fry the paste in the oil until fragrant.','Add the coconut milk and bring to a simmer.','Add the diced thigh and vegetables; simmer 12 minutes.','Season with fish sauce and a pinch of sugar; serve with rice.']},
      {name:'Quick',icon:'⚡',time:25,costPP:40,nutrition:{kcal:480,protein_g:32,carbs_g:18,fat_g:32},
        ...
        method:['Fry the paste in the oil 1 minute.','Add the coconut milk and simmer.','Add thinly sliced chicken and the beans; cook 8 minutes.','Season with fish sauce, tear in basil and serve.']},
      {name:'Vegetable & Tofu',icon:'🌱',time:30,costPP:34,nutrition:{kcal:420,protein_g:18,carbs_g:24,fat_g:30},
        ...
        method:['Press the tofu, cube it and fry in the oil until golden on all sides; set aside.','Fry the paste, add the coconut milk and simmer.','Add the vegetables and cook 6 minutes, then fold in the tofu.','Season with fish sauce (or soy for vegan), tear in basil and serve.']}
    ]},
  {id:'sp-moroccan-tagine', cat:'stewscurries', goesWith:['Couscous','Rice','Fresh coriander'], diet:'meat', protein:'lamb', name:'Moroccan Lamb & Apricot Tagine', emoji:'🍑', cuisine:'Moroccan', time:120, costPP:54,
    ...
    versions:[
      {name:'Lamb & Apricot',icon:'🏆',default:true,time:135,costPP:58,nutrition:{kcal:560,protein_g:33,carbs_g:40,fat_g:30},
        ...
        method:['Brown the lamb all over; set aside.','Soften the onion, bloom the ras el hanout 1 minute.','Return the lamb with tomato, apricots, chickpeas and stock.','Cover and braise gently 1.5–2 hours until tender.','Finish with coriander and serve over couscous.']},
      {name:'Budget',icon:'💰',time:90,costPP:34,nutrition:{kcal:480,protein_g:24,carbs_g:48,fat_g:20},
        ...
        method:['Brown the chicken; set aside.','Soften the onion, bloom the ras el hanout.','Return the chicken with tomato, apricots, chickpeas and stock.','Cover and simmer 40 minutes until tender. Serve over couscous.']},
      {name:'Chicken & Olive',icon:'🫒',time:90,costPP:40,nutrition:{kcal:470,protein_g:30,carbs_g:24,fat_g:28},
        ...
        method:['Brown the chicken; set aside.','Soften the onion, bloom the ras el hanout.','Return the chicken with the stock and lemon; cover and simmer 35 minutes.','Stir in the olives for the last 5 minutes, finish with coriander and serve.']},
      {name:'Vegetable (vegan)',icon:'🌱',time:60,costPP:30,nutrition:{kcal:420,protein_g:13,carbs_g:62,fat_g:14},
        ...
        method:['Soften the onion in the oil, bloom the ras el hanout.','Add the tomato, sweet potato, chickpeas, apricots and stock.','Cover and simmer 30–35 minutes until the sweet potato is tender and the sauce rich.','Serve over couscous with coriander.']}
    ]},
  {id:'sp-chicken-pilau', cat:'stewscurries', goesWith:['Carrot sambal','Banana sambal','Roti','Plain yoghurt'], diet:'meat', protein:'chicken', name:'Chicken Pilau', emoji:'🍚', cuisine:'Indian', time:50, costPP:38,
    ...
    versions:[
      ...
      {name:'Budget',icon:'💰',time:50,costPP:28,nutrition:{kcal:500,protein_g:26,carbs_g:64,fat_g:16},
        ...
        method:['Fry the onion until golden, add the chicken and brown.','Stir in the ginger-garlic and garam masala.','Add the rinsed rice, coat, then the stock; boil, cover and cook low 15 minutes.','Rest covered 10 minutes, fluff and serve.']},
      {name:'Quick',icon:'⚡',time:35,costPP:38,nutrition:{kcal:520,protein_g:28,carbs_g:62,fat_g:18},
        ...
        method:['Brown the onion and chicken together in the oil.','Add the ginger-garlic and garam masala, then the rinsed rice; coat well.','Pour in the stock, boil, cover and cook low 12 minutes.','Rest 8 minutes covered, fluff and serve.']}
    ]},
  ...
  {id:'sp-bobotie', cat:'ovenbakes', goesWith:['Yellow rice','Apricot chutney','Banana sambal','Carrot sambal'], diet:'meat', protein:'beef', name:'Classic Bobotie', emoji:'🍛', cuisine:'South African', time:75, costPP:34,
    ...
    method:['Soak the slice of bread in a little of the milk until soft.','Fry the chopped onion in the oil until soft, then stir in the curry powder and cook 1 minute until fragrant.','Add the mince and brown it, breaking up the lumps, then stir in the chutney, raisins and the soaked, mashed bread. Cook a few minutes until rich. Season well.','Press the mince into an oven dish and tuck a few bay leaves upright into the surface.','Beat the egg with the rest of the milk and the turmeric, pour it gently over the mince, and bake at 180°C until the custard is set and golden, about 35 minutes. Serve with yellow rice and chutney.'],
    ...
    versions:[
      {name:'Cape Malay',icon:'🏆',default:true,time:80,costPP:38,nutrition:{kcal:560,protein_g:30,carbs_g:36,fat_g:32},
        ...
        method:['Soak the bread in some of the milk.','Soften the onion, add curry powder, fry 1 minute.','Brown the mince, then stir in the chutney, raisins, flaked almonds and mashed bread; cook to rich. Season.','Press into a dish and stand bay leaves upright in the top.','Beat egg, remaining milk and turmeric; pour over and bake 180°C for 35 minutes until golden and set. Serve with yellow rice.']},
      {name:'Budget',icon:'💰',time:75,costPP:26,nutrition:{kcal:480,protein_g:24,carbs_g:42,fat_g:24},
        ...
        method:['Soak two slices of bread in the milk.','Soften the onion with the curry powder.','Brown the mince, stir in the chutney, raisins and plenty of soaked bread; season well.','Press into a dish, top with the egg-milk-turmeric custard and bake until set and golden.']},
      {name:'Quick',icon:'⚡',time:35,costPP:34,nutrition:{kcal:510,protein_g:28,carbs_g:36,fat_g:27},
        ...
        method:['Soak the bread in milk.','Fry the onion and curry powder, brown the mince, stir in chutney and soaked bread; season.','Spread in a heatproof dish, pour over the beaten egg, milk and turmeric.','Set under a hot grill 5–8 minutes until the custard is just set and golden. Serve at once.']},
      {name:'Lentil (veg)',icon:'🌱',time:70,costPP:24,nutrition:{kcal:430,protein_g:18,carbs_g:54,fat_g:14},
        ...
        method:['Simmer the brown lentils until soft but still holding shape; drain.','Soften the onion with the curry powder.','Stir in the lentils, chutney, raisins and soaked bread; season well.','Press into a dish, top with the egg-milk-turmeric custard and bay leaves, and bake 180°C for 30 minutes until set.']}
    ]},
  ...
  {id:'sp-fish-pie', cat:'ovenbakes', goesWith:['Frozen peas','Green salad','Lemon'], diet:'meat', protein:'fish', name:'Creamy Fish Pie', emoji:'🥧', cuisine:'British', time:50, costPP:53,
    ...
    method:['Poach the fish gently in the milk for a few minutes, then lift it out and flake it, keeping the milk.','Make a white sauce: melt the butter, stir in the flour, then whisk in the warm poaching milk until thick and smooth.','Fold the flaked fish and peas into the sauce and spread into a dish.','Boil and mash the potatoes, spread over the filling, scatter cheese and bake at 190°C until golden and bubbling, about 25 minutes.'],
    tip:'Use a mix of fish — smoked and white — for the most flavourful pie.',
    didYouKnow:'A classic fish pie was built on thrift and the catch of the day — a mix of white fish, smoked fish and whatever else was going, bound in sauce and stretched under cheap potato.',
    freezes:true, fridgeDays:2,
    ...
    versions:[
      {name:'Creamy',icon:'🏆',default:true,time:55,costPP:60,nutrition:{kcal:580,protein_g:34,carbs_g:50,fat_g:28},
        feel:'A mix of white fish, smoked fish and prawns in a parsley cream sauce, with hidden egg, under golden mash — the full luxurious pie.',
        tip:'Tuck quartered hard-boiled eggs into the filling — a traditional touch that makes every serving a little richer.',
        ...
        ingredients:[{n:'white fish',pp:90,u:'g'},{n:'smoked fish',pp:40,u:'g'},{n:'prawns',pp:40,u:'g'},{n:'eggs',pp:1,u:'each'},{n:'potatoes',pp:280,u:'g'},{n:'milk',pp:220,u:'ml'},{n:'cheddar',pp:30,u:'g'},{n:'frozen peas',pp:50,u:'g'},{n:'flour',pp:16,u:'g'},{n:'butter',pp:28,u:'g'},{n:'fresh parsley',pp:4,u:'g'}],
        method:['Poach the white and smoked fish in the milk; flake and reserve the milk.','Make a white sauce with butter, flour and the milk; stir in chopped parsley.','Fold in the fish, prawns and peas; spread in a dish and tuck in quartered boiled eggs.','Top with mash and cheese; bake 190°C for 28 minutes until golden.']},
      {name:'Budget',icon:'💰',time:50,costPP:40,nutrition:{kcal:540,protein_g:28,carbs_g:54,fat_g:22},
        feel:'Just good hake in the creamy sauce under plenty of mash — the everyday version.',
        tip:'Hake alone makes a lovely pie — lean on extra mash and peas to fill the dish affordably.',
        didYouKnow:'Hake on its own makes a perfectly good fish pie — the smoked fish and prawns of the deluxe version are a treat, not a requirement.',
        ingredients:[{n:'white fish',pp:120,u:'g'},{n:'potatoes',pp:300,u:'g'},{n:'milk',pp:200,u:'ml'},{n:'cheddar',pp:25,u:'g'},{n:'frozen peas',pp:60,u:'g'},{n:'flour',pp:15,u:'g'},{n:'butter',pp:22,u:'g'}],
        method:['Poach the hake in the milk; flake and keep the milk.','Make the white sauce; fold in the fish and peas.','Top with plenty of mash and a little cheese; bake until golden.']},
      {name:'Quick',icon:'⚡',time:30,costPP:53,nutrition:{kcal:560,protein_g:32,carbs_g:50,fat_g:26},
        feel:'Sauce, fish and peas grilled under quick mash — comfort without the wait.',
        tip:'Cut the fish small so it cooks straight in the hot sauce — no separate poaching needed.',
        ...
        ingredients:[{n:'white fish',pp:120,u:'g'},{n:'potatoes',pp:250,u:'g'},{n:'milk',pp:200,u:'ml'},{n:'cheddar',pp:30,u:'g'},{n:'frozen peas',pp:50,u:'g'},{n:'flour',pp:15,u:'g'},{n:'butter',pp:25,u:'g'}],
        method:['Boil diced potato for quick mash.','Make the white sauce, stir in diced raw fish and peas, and cook 4 minutes until the fish is just done.','Spread in a dish, top with mash and cheese, and grill until golden.']}
    ]},
  {id:'sp-nacho-bake', cat:'ovenbakes', goesWith:['Sour cream','Avocado','Fresh coriander'], diet:'meat', protein:'beef', name:'Tex-Mex Beef Nacho Bake', emoji:'🌮', cuisine:'Tex-Mex', time:40, costPP:38,
    ...
    method:['Brown the mince with the onion and taco spice, then stir in the tomato and drained beans and simmer into a thick chilli.','Scatter half the tortilla chips in a dish, spoon over the beef, then the rest of the chips.','Cover with grated cheese and bake at 180°C until melted and bubbling, about 12 minutes.','Top with avo, salsa and a dollop of sour cream and serve straight away.'],
    ...
    versions:[
      {name:'Loaded',icon:'🏆',default:true,time:40,costPP:42,nutrition:{kcal:640,protein_g:30,carbs_g:54,fat_g:34},
        feel:'A thick spiced beef-and-bean chilli layered with chips and melted cheese, piled high with avo, salsa and sour cream.',
        tip:'Build it in two layers — chips, beef, cheese, then chips, beef, cheese — so every forkful has melted cheese, not just the top.',
        didYouKnow:'Layering the chips in stages, rather than all at the bottom, keeps some crunchy and lets cheese melt right through the bake instead of only crusting the surface.',
        ingredients:[{n:'beef mince',pp:140,u:'g'},{n:'tortilla chips',pp:60,u:'g'},{n:'tinned beans',pp:70,u:'g'},{n:'tomato',pp:90,u:'g'},{n:'cheddar',pp:60,u:'g'},{n:'onion',pp:50,u:'g'},{n:'taco spice',pp:7,u:'g'},{n:'avocado',pp:40,u:'g'},{n:'sour cream',pp:30,u:'g'},{n:'oil',pp:10,u:'ml'}],
        method:['Brown the mince with onion and taco spice; add tomato and beans; simmer thick.','Layer chips, beef, cheese — twice.','Bake 180°C for 12 minutes until bubbling.','Top with avocado, salsa and sour cream.']},
      {name:'Budget',icon:'💰',time:40,costPP:28,nutrition:{kcal:560,protein_g:24,carbs_g:58,fat_g:24},
        feel:'More beans, less mince — a big, cheap, crowd-pleasing tray.',
        tip:'Beans are cheaper than mince and just as filling here — push the ratio towards beans and no one minds.',
        ...
        ingredients:[{n:'beef mince',pp:80,u:'g'},{n:'tortilla chips',pp:50,u:'g'},{n:'tinned beans',pp:120,u:'g'},{n:'tomato',pp:80,u:'g'},{n:'cheddar',pp:40,u:'g'},{n:'onion',pp:50,u:'g'},{n:'taco spice',pp:6,u:'g'},{n:'oil',pp:10,u:'ml'}],
        method:['Brown the mince and onion with taco spice; stir in a double helping of beans and the tomato.','Layer with chips and cheese.','Bake until melted and bubbling. Serve.']},
      {name:'Vegetarian',icon:'🌱',time:35,costPP:30,nutrition:{kcal:520,protein_g:18,carbs_g:64,fat_g:22},
        ...
        tip:'Mash some of the beans into the sauce to give it body where the mince would have been.',
        ...
        ingredients:[{n:'tinned beans',pp:80,u:'g'},{n:'black beans',pp:80,u:'g'},{n:'tortilla chips',pp:50,u:'g'},{n:'tomato',pp:90,u:'g'},{n:'cheddar',pp:50,u:'g'},{n:'onion',pp:50,u:'g'},{n:'taco spice',pp:7,u:'g'},{n:'oil',pp:10,u:'ml'}],
        method:['Fry the onion with taco spice; add both beans and the tomato, mashing some, and simmer thick.','Layer with chips and cheese.','Bake 180°C for 12 minutes. Top with avo and serve.']}
    ]},
  {id:'sp-moussaka', cat:'ovenbakes', goesWith:['Greek salad','Crusty bread','Green salad'], diet:'meat', protein:'lamb', name:'Greek Lamb Moussaka', emoji:'🍆', cuisine:'Greek', time:75, costPP:51,
    ...
    method:['Slice the aubergine and potato and fry (or roast) until golden and soft.','Cook the lamb mince with onion, tomato and a good pinch of cinnamon into a rich ragu. Season well.','Make a bechamel: melt the butter, stir in the flour, then whisk in the milk over the heat until thick and smooth.','Layer potato, aubergine and lamb in a dish, pour over the bechamel, scatter cheese and bake at 180°C until golden, about 35 minutes.','Rest 15 minutes before cutting so the layers hold.'],
    tip:'Let it rest 15 minutes before cutting so the layers hold together instead of sliding apart.',
    ...
    versions:[
      {name:'Classic',icon:'🏆',default:true,time:85,costPP:55,nutrition:{kcal:650,protein_g:31,carbs_g:38,fat_g:42},
        feel:'Golden aubergine, cinnamon-warmed lamb ragu and a thick, cheesy béchamel, baked and rested into clean, proud layers.',
        tip:'Salt the aubergine slices and let them sit 15 minutes, then pat dry — it draws out bitterness and stops them soaking up oil.',
        didYouKnow:'The warm-spice note that makes moussaka taste unmistakably Greek comes from cinnamon and sometimes allspice in the lamb — a legacy of the eastern Mediterranean spice trade.',
        ingredients:[{n:'lamb mince',pp:150,u:'g'},{n:'aubergine',pp:140,u:'g'},{n:'potato',pp:110,u:'g'},{n:'tomato',pp:110,u:'g'},{n:'onion',pp:50,u:'g'},{n:'milk',pp:170,u:'ml'},{n:'flour',pp:16,u:'g'},{n:'butter',pp:22,u:'g'},{n:'cheddar',pp:30,u:'g'},{n:'oil',pp:16,u:'ml'}],
        method:['Salt, rest and pat the aubergine; fry with the potato until golden.','Cook the lamb with onion, tomato and cinnamon into a thick ragu.','Make a thick béchamel and beat in half the cheese.','Layer potato, aubergine, lamb; top with béchamel and the rest of the cheese.','Bake 180°C for 40 minutes until golden; rest 15 minutes before cutting.']},
      {name:'Budget',icon:'💰',time:75,costPP:36,nutrition:{kcal:560,protein_g:22,carbs_g:50,fat_g:28},
        feel:'More potato, less lamb — a hearty, layered bake that stretches the meat.',
        tip:'Build it potato-heavy with a thinner layer of lamb ragu — the spiced sauce flavours the whole dish anyway.',
        didYouKnow:'Layering generously with potato and a thinner spread of lamb keeps the spiced, layered character while using far less of the costly mince.',
        ingredients:[{n:'lamb mince',pp:90,u:'g'},{n:'aubergine',pp:100,u:'g'},{n:'potato',pp:200,u:'g'},{n:'tomato',pp:100,u:'g'},{n:'onion',pp:50,u:'g'},{n:'milk',pp:150,u:'ml'},{n:'flour',pp:15,u:'g'},{n:'butter',pp:18,u:'g'},{n:'cheddar',pp:20,u:'g'},{n:'oil',pp:14,u:'ml'}],
        method:['Fry the aubergine and plenty of potato until golden.','Cook a thinner lamb-and-tomato ragu with cinnamon.','Make the béchamel.','Layer potato-heavy, top with béchamel and cheese, and bake until golden.']},
      {name:'Vegetarian',icon:'🌱',time:70,costPP:30,nutrition:{kcal:480,protein_g:16,carbs_g:54,fat_g:22},
        feel:'Lentils and chickpeas in place of lamb, the same aubergine and béchamel — a hearty meat-free moussaka.',
        tip:'A spoon of tomato paste and the cinnamon keep the lentil layer tasting rich and "meaty".',
        didYouKnow:'Lentils and chickpeas stand in for the lamb beautifully — the dish\'s identity lives in the aubergine, cinnamon and béchamel as much as the meat.',
        ingredients:[{n:'brown lentils',pp:90,u:'g'},{n:'chickpeas',pp:50,u:'g'},{n:'aubergine',pp:140,u:'g'},{n:'potato',pp:120,u:'g'},{n:'tomato',pp:110,u:'g'},{n:'onion',pp:50,u:'g'},{n:'milk',pp:160,u:'ml'},{n:'flour',pp:15,u:'g'},{n:'butter',pp:20,u:'g'},{n:'cheddar',pp:25,u:'g'},{n:'oil',pp:16,u:'ml'}],
        method:['Fry the aubergine and potato until golden.','Cook the lentils and chickpeas with onion, tomato, tomato paste and cinnamon into a rich base.','Make the béchamel.','Layer, top with béchamel and cheese, and bake 180°C for 35 minutes. Rest before cutting.']}
    ]},
  {id:'sp-shepherds-pie', cat:'ovenbakes', goesWith:['Frozen peas','Green salad','Gravy'], diet:'meat', protein:'lamb', name:'Shepherd\'s Pie', emoji:'🐑', cuisine:'British', time:60, costPP:48,
    ...
    method:['Brown the lamb mince with the chopped onion and carrots.','Stir in the flour, then the stock and peas, and simmer into a rich gravy.','Spread in an oven dish and top with buttery mash, roughing up the surface with a fork.','Bake at 190°C for 25–30 minutes until the top is golden and crisp.'],
    ...
    versions:[
      {name:'Classic',icon:'🏆',default:true,time:65,costPP:50,nutrition:{kcal:580,protein_g:29,carbs_g:48,fat_g:30},
        feel:'Rich lamb gravy with rosemary and carrots under golden, forked mash — the proper Sunday-comfort version.',
        tip:'A little rosemary or thyme in the lamb gravy is what makes it taste distinctly of shepherd\'s pie rather than cottage pie.',
        didYouKnow:'Lamb\'s natural fat carries herbs beautifully, which is why rosemary and thyme belong here — they cut the richness and give the gravy its characteristic flavour.',
        ingredients:[{n:'lamb mince',pp:150,u:'g'},{n:'potatoes',pp:280,u:'g'},{n:'carrots',pp:70,u:'g'},{n:'frozen peas',pp:50,u:'g'},{n:'onion',pp:60,u:'g'},{n:'beef stock',pp:130,u:'ml'},{n:'flour',pp:10,u:'g'},{n:'butter',pp:22,u:'g'},{n:'milk',pp:30,u:'ml'}],
        method:['Brown the lamb with onion and carrot; pour off excess fat.','Stir in flour and a little rosemary, then the stock and peas; simmer to a rich gravy.','Mash the potatoes with butter and milk.','Top, fork the surface and bake 190°C for 30 minutes until golden.']},
      {name:'Budget',icon:'💰',time:60,costPP:34,nutrition:{kcal:520,protein_g:22,carbs_g:54,fat_g:22},
        feel:'Half lamb, half lentils, more mash — the same comfort for a lot less.',
        tip:'Lamb is the priciest mince — stretch it with cooked lentils and lean on extra mash and veg.',
        didYouKnow:'Lamb mince is the most expensive of the common minces, so stretching it with lentils or extra vegetables is the classic way to keep this pie affordable.',
        ingredients:[{n:'lamb mince',pp:80,u:'g'},{n:'brown lentils',pp:50,u:'g'},{n:'potatoes',pp:300,u:'g'},{n:'carrots',pp:70,u:'g'},{n:'frozen peas',pp:50,u:'g'},{n:'onion',pp:50,u:'g'},{n:'beef stock',pp:120,u:'ml'},{n:'flour',pp:8,u:'g'},{n:'butter',pp:18,u:'g'}],
        method:['Brown the lamb with onion and carrot, stir in the cooked lentils.','Add flour, stock and peas; simmer to a gravy.','Top with plenty of buttery mash, fork and bake until golden.']},
      {name:'Quick',icon:'⚡',time:35,costPP:48,nutrition:{kcal:560,protein_g:28,carbs_g:48,fat_g:28},
        feel:'Fast lamb gravy, quick mash, grilled golden — weeknight shepherd\'s pie.',
        tip:'Pre-boil diced potato while the gravy cooks, then grill the assembled pie rather than baking from cold.',
        ...
        ingredients:[{n:'lamb mince',pp:140,u:'g'},{n:'potatoes',pp:250,u:'g'},{n:'frozen peas',pp:50,u:'g'},{n:'onion',pp:50,u:'g'},{n:'beef stock',pp:120,u:'ml'},{n:'flour',pp:8,u:'g'},{n:'butter',pp:20,u:'g'}],
        method:['Boil diced potato until quick to mash.','Brown the lamb and onion, add flour, stock and peas; simmer 10 minutes.','Top with mash, fork and grill 6–8 minutes until golden.']}
    ]},
  {id:'sp-chicken-bacon-bake', cat:'ovenbakes', goesWith:['Green salad','Garlic bread','Frozen peas'], diet:'meat', protein:'chicken', name:'Loaded Chicken & Bacon Pasta Bake', emoji:'🧀', cuisine:'Family classic', time:45, costPP:44,
    ...
    versions:[
      {name:'Loaded',icon:'🏆',default:true,time:45,costPP:48,nutrition:{kcal:700,protein_g:40,carbs_g:58,fat_g:36},
        feel:'Extra bacon, a rich garlic-cream sauce and a thick double-cheese crust — the full crowd-pleaser.',
        tip:'Reserve a handful of bacon and cheese to scatter on after baking, so the topping has both melt and crunch.',
        didYouKnow:'Cooking the pasta a minute short of done is the secret to any pasta bake — it finishes cooking in the oven and soaks up the sauce instead of turning soft.',
        ingredients:[{n:'chicken breast',pp:130,u:'g'},{n:'bacon',pp:55,u:'g'},{n:'pasta',pp:95,u:'g'},{n:'cream',pp:60,u:'ml'},{n:'cheddar',pp:65,u:'g'},{n:'onion',pp:45,u:'g'},{n:'garlic',pp:8,u:'g'},{n:'chicken stock',pp:100,u:'ml'}],
        method:['Cook the pasta a minute under; drain.','Sear the chicken, crisp the bacon, soften onion and garlic.','Add cream and stock; simmer to a sauce; fold in pasta, chicken and most of the bacon.','Top with plenty of cheese, bake 180°C for 20 min, then scatter reserved bacon.']},
      {name:'Budget',icon:'💰',time:45,costPP:32,nutrition:{kcal:600,protein_g:28,carbs_g:64,fat_g:24},
        ...
        method:['Cook the pasta a minute under.','Sear the chicken and bacon; set aside.','Make a béchamel with butter, flour and milk; stir in cheese.','Fold in pasta, chicken and bacon, top with cheese and bake until golden.']},
      {name:'Quick',icon:'⚡',time:30,costPP:44,nutrition:{kcal:660,protein_g:38,carbs_g:58,fat_g:32},
        ...
        method:['Cook the pasta. Sear chicken and bacon, soften onion and garlic.','Add cream, simmer to a sauce, fold in the pasta.','Tip into a heatproof dish, top with cheese and grill until melted and golden.']}
    ]},
  ...
  {id:'sp-cowboy-bake', cat:'ovenbakes', goesWith:['Green salad','Crusty bread','Sour cream'], diet:'meat', protein:'beef', name:'Cowboy Bean & Beef Bake', emoji:'🫘', cuisine:'American', time:50, costPP:40,
    ...
    method:['Brown the mince with the onion and smoky spice.','Stir in the tomato and baked beans and simmer briefly into a thick, saucy base.','Tip into a dish and layer thinly sliced potato over the top, overlapping like tiles.','Scatter with cheese and bake at 180°C for about 30 minutes until the potato is tender and the top golden.'],
    ...
    versions:[
      {name:'Smoky',icon:'🏆',default:true,time:55,costPP:44,nutrition:{kcal:610,protein_g:30,carbs_g:54,fat_g:30},
        feel:'Smoky-spiced beef and beans under overlapping potato slices and a golden cheese crust — proper rib-sticking comfort.',
        tip:'A dash of smoked paprika and a spoon of brown sugar or BBQ sauce give the beans that smoky-sweet chuckwagon depth.',
        ...
        ingredients:[{n:'beef mince',pp:140,u:'g'},{n:'baked beans',pp:110,u:'g'},{n:'potato',pp:170,u:'g'},{n:'onion',pp:60,u:'g'},{n:'cheddar',pp:50,u:'g'},{n:'smoked paprika',pp:5,u:'g'},{n:'tomato',pp:70,u:'g'},{n:'oil',pp:10,u:'ml'}],
        method:['Brown the mince with onion and smoked paprika.','Stir in tomato, baked beans and a spoon of BBQ sauce or sugar; simmer thick.','Tip into a dish, tile thin potato slices over the top.','Scatter cheese and bake 180°C for 30 min until golden.']},
      {name:'Budget',icon:'💰',time:50,costPP:30,nutrition:{kcal:540,protein_g:22,carbs_g:62,fat_g:20},
        feel:'Beans-forward with just enough beef for flavour, under plenty of potato — a huge, cheap tray.',
        tip:'Two tins of beans and a little mince feeds a crowd for very little — the potato lid does the filling.',
        ...
        ingredients:[{n:'beef mince',pp:80,u:'g'},{n:'baked beans',pp:150,u:'g'},{n:'potato',pp:200,u:'g'},{n:'onion',pp:50,u:'g'},{n:'cheddar',pp:30,u:'g'},{n:'smoky spice',pp:5,u:'g'},{n:'tomato',pp:60,u:'g'},{n:'oil',pp:10,u:'ml'}],
        method:['Brown the little bit of mince with onion and smoky spice.','Stir in plenty of beans and the tomato; simmer.','Top with lots of thin potato and a little cheese; bake until tender and golden.']},
      {name:'Quick',icon:'⚡',time:30,costPP:40,nutrition:{kcal:580,protein_g:28,carbs_g:54,fat_g:28},
        feel:'Par-boiled potato slices over a fast beef-and-bean base, grilled golden — comfort in half an hour.',
        tip:'Microwave or par-boil the potato slices for 5 minutes first so they finish quickly under the grill.',
        ...
        ingredients:[{n:'beef mince',pp:130,u:'g'},{n:'baked beans',pp:100,u:'g'},{n:'potato',pp:150,u:'g'},{n:'onion',pp:50,u:'g'},{n:'cheddar',pp:40,u:'g'},{n:'smoky spice',pp:5,u:'g'},{n:'tomato',pp:60,u:'g'},{n:'oil',pp:10,u:'ml'}],
        method:['Par-boil thin potato slices 5 minutes.','Brown the mince with onion and smoky spice; stir in tomato and beans.','Top with the potato and cheese; grill 6–8 minutes until golden.']}
    ]},
