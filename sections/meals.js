...
function mealSectionHTML(sectionKey){
  const configs = {
    ...
    sidesbasics:{title:"Sides & Basics",    emoji:"🍟", color:"#c08040", bg:"#180f08", border:"#3a2410", recipes:typeof SIDES_BASICS_RECIPES!=='undefined'?SIDES_BASICS_RECIPES:[], sub:"Chips · Mash · the building blocks", cats:[{id:'potato',e:'🥔',l:'Potato Sides'},{id:'rice',e:'🍚',l:'Rice & Grains'},{id:'sauces',e:'🥫',l:'Basic Sauces'}]},
  };
