function furryHTML(){
  ...
  return `<div style="min-height:100vh;background:#0f0e0c;">
    ...
    <div style="position:relative;height:200px;overflow:hidden;background:linear-gradient(135deg,#120f1a 0%,#1a1028 100%);">
      ...
      <button onclick="set({screen:'tinyfurry'})" style="position:absolute;top:14px;left:16px;z-index:3;background:rgba(0,0,0,0.45);border:1px solid #6040b0;border-radius:20px;color:#9769d3;font-size:12px;padding:5px 12px;cursor:pointer;">← Tiny & Furry</button>
      <div style="position:absolute;bottom:0;left:0;right:0;z-index:2;padding:14px 16px 0;">
        ...
        <div style="display:flex;align-items:center;background:rgba(18,15,26,0.85);border:1px solid #6040b0;border-radius:20px;padding:7px 14px;margin-bottom:14px;">
          <span style="color:#9769d3;margin-right:8px;font-size:14px;">🔍</span>
          ...
          />
          ${S.furrySearch?`<button onclick="set({furrySearch:''})" style="background:none;border:none;color:#8d73cc;font-size:16px;cursor:pointer;">×</button>`:''}
        </div>
      </div>
    </div>
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;">
        <div style="flex:1;">
          <button onclick="set({furryHowOpen:!S.furryHowOpen})"
            style="background:none;border:none;color:#9769d3;font-size:12px;cursor:pointer;padding:0;display:flex;align-items:center;gap:4px;">
          ...
          ${furryHowOpen?`
            ...
            <div style="position:relative;z-index:10;background:#0f0c18;border:1px solid #3a2050;border-radius:10px;padding:12px;margin-top:8px;font-size:12px;color:#b090d0;line-height:1.6;">
              <strong style="color:#9769d3;">1. Pick your pet</strong> — Dogs or Cats.<br>
              <strong style="color:#9769d3;">2. Choose a category</strong> — cooked meals, treats, raw food and more.<br>
              <strong style="color:#9769d3;">3. Scale by size & age</strong> — portions adjust automatically.<br>
              <span style="color:#8d73cc;font-size:11px;">All recipes vet-reviewed. No harmful ingredients.</span>
            </div>
          `:''}
        </div>
        <!-- Pet toggle -->
