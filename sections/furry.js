function furryHTML(){
  ...
  return `<div style="min-height:100vh;background:#0f0e0c;">
    ...
    <div style="position:relative;height:200px;overflow:hidden;background:linear-gradient(135deg,#1a1208 0%,#1a1208 100%);">
      ...
      <button onclick="set({screen:'tinyfurry'})" style="position:absolute;top:14px;left:16px;z-index:3;background:rgba(0,0,0,0.45);border:1px solid #c06020;border-radius:20px;color:#c06020;font-size:12px;padding:5px 12px;cursor:pointer;">← Tiny & Furry</button>
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;">
        <div style="flex:1;">
          ...
          ${furryHowOpen?`
            ...
            <div style="position:relative;z-index:10;background:#161210;border:1px solid #3a2010;border-radius:10px;padding:12px;margin-top:8px;font-size:12px;color:#c8b898;line-height:1.6;">
              ...
              <span style="color:#c06020;font-size:11px;">All recipes vet-reviewed. No harmful ingredients.</span>
            </div>
          `:''}
        </div>
        <!-- Pet toggle -->
