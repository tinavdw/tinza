...
const SIDES_GROUPS = [
  ...
  { id:"extras", label:"🍞 Breads", items:[
    ...
    { id:"roosterkoek", name:"Roosterkoek (Braai Bread Rolls)", emoji:"🍞", tier:"free", perPerson:1, unit:"roll", note:"Smoky crust — cooked over coals", pantryP:4, stdP:5, indulgeP:6,
