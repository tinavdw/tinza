...
function lookupPrice(name){
  ...
  // Partial match — longest DB key that appears AS A SUBSTRING OF the query, wins.
  // MF28-L1: the old `|| key.includes(q)` direction let a SHORTER query match a
  // LONGER key ("sprouts" query hitting "brussels sprouts"; "milk" hitting nothing
