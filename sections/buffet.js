...
const KIDS_THEMES = [
  ...
  { id:'pirate', emoji:'🏴‍☠️', name:'Pirate Treasure Party', palette:'Black · Red · Gold · Deep blue', vibe:'Swashbuckling treasure hunt fun',
    ...
    recipes:[
      ...
      {name:'Pirate Pizza Coins',type:'savoury',per:2,unit:'coins',base12:{muffins:'12 English muffins',tomato_sauce:'300g tomato pasta sauce',cheese:'300g grated cheddar'},method:'PLACEHOLDER - to be replaced by the Finger Foods pizza recipe once that section is fixed. Spread sauce on muffin halves, top with cheese. Bake 180°C for 12 min.',time:22,kcal:165},
  ...
  { id:'mermaid', emoji:'🧜', name:'Mermaid Lagoon Party', palette:'Turquoise · Ocean blue · Coral pink · Pearl white', vibe:'Underwater magic — elegant and shimmering',
    ...
    recipes:[
      {name:'Seashell Pasta Cups',type:'savoury',per:2,unit:'cups',base12:{pasta:'400g shell pasta',butter:'30g butter',flour:'30g flour',milk:'200ml milk',cheese:'160g cheddar',tuna:'150g tuna'},method:'Cook the pasta. CHEESE SAUCE: melt butter, whisk in flour 1 min, gradually add milk whisking until thick, stir in 60g of the cheddar until smooth. Mix sauce with pasta and tuna (or ham), spoon into cups, top with remaining cheddar. Bake 180°C for 10 min.',time:27,kcal:140},
      {name:'Ocean Sandwich Shapes',type:'savoury',per:2,unit:'shapes',base12:{bread:'2 loaves sliced bread',eggs:'6 eggs',chicken:'300g chicken',mayonnaise:'150g mayonnaise'},method:'PLACEHOLDER - to be replaced by the Finger Foods sandwich recipes once that section is fixed. Make 1 egg-mayo and 1 chicken-mayo sandwich per child: boil and mash eggs with mayo; shred chicken with mayo. Cut into fish/shell/starfish shapes with cutters. (Eggs scale at 1 per 6 kids... here boiled for filling.)',time:20,kcal:165},
      {name:'Mermaid Jelly Cups',type:'sweet',per:1,unit:'cup',base12:{jelly_powder:'6 packets jelly',hot_water:'1200ml hot water',cold_water:'1200ml cold water',mixed_fruit:'360g mixed fruit'},method:'Dissolve 3 blue jelly packets in 600ml boiling water, add 600ml cold water; repeat for green. Pour a ~40ml blue layer into each of 12 cups, chill 45-60 min until just set. Press in a few pieces of pineapple or halved grapes, pour green layer over, chill again. Repeat until full and firm (3-4 hours or overnight).',time:240,kcal:90},
  ...
  { id:'safari', emoji:'🦁', name:'Safari Adventure Party', palette:'Terracotta orange · Olive green · Sandy beige', vibe:'Wild African adventure — strong South African appeal',
    ...
    recipes:[
      ...
      {name:'Lion Paw Mini Pizzas',type:'savoury',per:2,unit:'minis',base12:{muffins:'12 English muffins',tomato_sauce:'300g tomato pasta sauce',beef_mince:'300g beef mince',cheese:'300g grated cheddar'},method:'PLACEHOLDER - to be replaced by the Finger Foods mince mini-pizza recipe (already scaled) once that section is fixed. Spread sauce on muffin halves, top with cooked mince and cheese. Bake 180°C for 12 min.',time:25,kcal:170},
      ...
      {name:'Banana Jungle Muffins',type:'healthy',per:2,unit:'mini muffins',base12:{bananas:'400g ripe bananas',flour:'200g flour',sugar:'100g sugar',eggs:'2 eggs',oil:'100ml oil',baking_powder:'10g baking powder'},method:'PLACEHOLDER - to be replaced by the Health-section banana muffin recipe (has baking powder) once linked. Mash bananas, mix with wet then dry ingredients (incl. baking powder). Bake in mini tins at 180°C for 18 min.',time:33,kcal:95},
  ...
  { id:'rainbow', emoji:'🌈', name:'Rainbow Picnic Party', palette:'All bright rainbow colours · Natural greens and yellows', vibe:'Fresh, healthy and full of outdoor picnic fun',
    ...
    recipes:[
      ...
      {name:'Mini Picnic Sandwiches',type:'savoury',per:2,unit:'minis',base12:{bread:'2 loaves sliced bread',tuna:'300g tuna',cheese:'200g cheese',mayonnaise:'100g mayonnaise'},method:'PLACEHOLDER - to be replaced by the Finger Foods scaled tuna & cheese sandwiches once that section is fixed. Make tuna-mayo and cheese sandwiches, cut into triangles or rounds.',time:15,kcal:160},
      {name:'BBQ Chicken Wings',type:'savoury',per:2,unit:'wings',base12:{chicken_wings:'1200g chicken wings',bbq_sauce:'250ml bbq sauce'},method:'PLACEHOLDER - to be replaced by the Finger Foods BBQ chicken wings recipe once that section is fixed. Added because this theme was light on meaty options. Coat wings in BBQ sauce, bake at 200°C for ~35 min until cooked and sticky.',time:45,kcal:160},
      ...
      {name:'Oat Banana Muffins',type:'healthy',per:2,unit:'mini muffins',base12:{oats:'300g oats',bananas:'400g bananas',eggs:'2 eggs',milk:'100ml milk',honey:'50g honey',baking_powder:'10g baking powder'},method:'PLACEHOLDER - to be replaced by the Health-section banana muffin recipe (has baking powder) once linked. Mash bananas, mix with oats, eggs, milk, honey and baking powder. Bake in mini tins at 180°C for 18 min.',time:33,kcal:90},
    ...
    cake:{name:'Rainbow Naked Cake',base12:{flour:'300g flour',baking_powder:'10g baking powder',sugar:'250g sugar',butter:'200g butter',eggs:'4 eggs',milk:'150ml milk',cream_cheese:'300g cream cheese',icing_sugar:'100g icing sugar',fresh_fruit:'240g fresh fruit'},method:'Cream butter & sugar, beat in eggs and milk, fold in flour + baking powder. Divide into 6 bowls, colour each (red/orange/yellow/green/blue/purple). Bake thin layers at 180°C for 12-15 min, cool completely. ICING: beat room-temp cream cheese smooth, sift in icing sugar, mix just until combined (do not overbeat). Stack layers with a thin "glue" layer of icing between, leaving sides exposed (naked look). Top generously with fresh fruit.',kcal:360},
  ...
  { id:'farmyard', emoji:'🐄', name:'Farmyard Fun Party', palette:'Red · Yellow · Green · Brown · Barn red', vibe:'Wholesome, friendly farmyard fun',
    ...
    recipes:[
      ...
      {name:'Haystack Cookies',type:'sweet',per:2,unit:'haystacks',base12:{noodles:'200g chow mein noodles',chocolate:'300g milk chocolate'},method:'PLACEHOLDER - to be replaced by one of the Finger Foods sweet treats once that section is fixed. Mix noodles (or pretzels) with melted chocolate, drop spoonfuls onto a tray to look like haystacks. Chill to set.',time:40,kcal:140},
      {name:'Apple Oat Muffins',type:'healthy',per:2,unit:'mini muffins',base12:{oats:'300g oats',apples:'400g apples',eggs:'2 eggs',milk:'100ml milk',honey:'50g honey',baking_powder:'10g baking powder'},method:'PLACEHOLDER - to be replaced by the Health-section banana/oat muffin recipe (has baking powder) once linked. Grate apples, mix all ingredients (incl. baking powder), bake in mini tins at 180°C for 18 min.',time:33,kcal:95},
  ...
  { id:'braai', emoji:'🔥', name:'Braai Party', palette:'Red · Orange · Green · Brown · Gold', vibe:'Fun, smoky, family-style South African braai — relaxed and delicious',
    ...
    recipes:[
      ...
      {name:'Braai Chicken Wings',type:'savoury',per:2,unit:'wings',base12:{chicken_wings:'1200g chicken wings',bbq_sauce:'250ml bbq sauce'},method:'PLACEHOLDER - to be replaced by the Finger Foods chicken wings recipe once that section is fixed. Toss wings in marinade/BBQ sauce, braai or bake at 200°C for 25 min, turning halfway.',time:35,kcal:110},
      ...
      {name:'Koeksister Bites',type:'sweet',per:2,unit:'bites',base12:{koeksisters:'300g koeksisters',syrup:'100ml syrup'},method:'PLACEHOLDER - to be replaced by the Finger Foods sweet koeksister recipe once that section is fixed. Cut larger koeksisters into bite-size pieces, serve with extra syrup.',time:10,kcal:130},
  ...
  { id:'big5', emoji:'🦒', name:'Big 5 Bushveld Safari', palette:'Khaki · Olive green · Terracotta · Safari beige · Warm gold', vibe:'Authentic South African bushveld adventure — wild and educational',
    ...
    recipes:[
      ...
      {name:'Elephant Ear Cookies',type:'sweet',per:2,unit:'cookies',base12:{butter:'250g butter',sugar:'150g sugar',flour:'350g flour',cinnamon:'5g cinnamon',cinnamon_sugar:'100g sugar'},method:'Cream butter & sugar, add flour to make a dough. Roll out and cut into large "ear" shapes. Mix the cinnamon with 100g sugar and sprinkle over. Bake 180°C for 12 min.',time:27,kcal:130},
