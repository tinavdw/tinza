...
function renderHealthMyPlan(isPro){
  ...
  return '<div style="font-size:16px;color:var(--gold);font-weight:bold;margin-bottom:4px;font-family:Georgia,serif;">📋 My Health Plan</div>'
    ...
    +(isPro
      ...
      : '<div style="background:var(--card);border:1px solid var(--line2);border-radius:10px;padding:12px;margin-bottom:12px;text-align:center;"><div style="font-size:13px;color:var(--ink-soft);">🔥 Calorie counter — <strong style="color:var(--gold);">Tinza Pro R90/month</strong></div></div>')
    +'<div style="background:var(--card);border:1px solid var(--line2);border-radius:10px;padding:14px;margin-bottom:12px;">'
      ...
      +(isPro
        ...
        : '<div style="font-size:13px;color:var(--ink-soft);">💰 Cost totals — <strong style="color:var(--gold);">Tinza Pro R90/month</strong></div>')
    +'</div>'
